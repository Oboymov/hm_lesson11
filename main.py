...
from utils import load_candidates_from_jason, get_candidate, get_candidates_by_name, get_candidates_by_skill
...
@app.route('/')
def main_page():
    candidates: list[dict] = load_candidates_from_jason()
    return flask.render_template('list.html', candidates=candidates)
